          ...
          buttons: [
            {
              ...
              onClick: async () => {
                ...
                socket.emit("webrtc-answer", { room: conId, answer, name: currentUser.username, callerId: callerId });
              }
            },
            {
              label: 'No',
...
//           const offer = await pc.current.createOffer();
//           await pc.current.setLocalDescription(offer);
//           socket.emit("webrtc-offer", { name: currentUser.username, room: conId, isVideo: isVideoCall, offer });
//     }
...
//        <div className="flex justify-center">
//        <button onClick={()=> navigate(`/chat_user?conId=${conId}`)} className=" flex justify-center items-center  w-20 h-20 bg-red-400 rounded-full hover:bg-red-800">
//             <MdCallEnd className="text-white text-5xl" />
// </button>
//        </div>
