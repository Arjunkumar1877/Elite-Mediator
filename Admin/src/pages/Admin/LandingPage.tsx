    ...
    <div className="relative bg-white  overflow-hidden p-8 md:p-10 lg:p-0">
      ...
      <div className="relative flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0 mt-40">
        ...
        <div className="lg:w-1/2 flex justify-center lg:justify-end">
          <img
            src={ posters.length > 0 ? posters[0]?.imageUrl : "https://firebasestorage.googleapis.com/v0/b/elite-mediator.appspot.com/o/1721058856452_Capture.PNG?alt=media&token=8e4ddf1c-00a3-4077-b2be-36bea2bbdb04"}
            alt="Illustration"
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between">
        <div className="">
          <img
            src={posters.length > 0  ?  posters[1]?.imageUrl : "https://firebasestorage.googleapis.com/v0/b/elite-mediator.appspot.com/o/1721057073374_landingpage2.png?alt=media&token=ad06005d-e2de-4981-8c44-dc3016d7caa9"}
            alt=""
      ...
      <div className="mt-8 mb-32 flex flex-col lg:flex-row lg:justify-between">
        <div className="">
          <img
            src={posters.length > 0 ? posters[2]?.imageUrl : "https://firebasestorage.googleapis.com/v0/b/elite-mediator.appspot.com/o/1721057084411_landingpage3.png?alt=media&token=91cb7b6e-3c32-4f9f-b07b-7094f1fb4869"}
            alt=""
            className="h-auto w-90 md:h-72 md:60"
          />
        </div>
      ...
      <div className="flex flex-col mt-11 items-center justify-center p-6 bg-white md:p-12 ">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div className=" bg-blue-100 rounded-xl md:w-90 md:h-72 overflow-hidden">
            <img
              src={posters.length > 0 ? posters[3]?.imageUrl : "https://firebasestorage.googleapis.com/v0/b/elite-mediator.appspot.com/o/1721057095865_landingPageImg1.avif?alt=media&token=ded48002-ad32-4146-ac94-7390cbb472d2"}
              alt=""
          ...
          <div className=" bg-blue-100 rounded-xl md:w-90 md:h-72 overflow-hidden">
            <img
               src={posters.length > 0 ? posters[4]?.imageUrl : "https://firebasestorage.googleapis.com/v0/b/elite-mediator.appspot.com/o/1721057116338_landingPageImg2.avif?alt=media&token=315fa014-7816-4406-85a3-d1c46e1ad53a"}
              alt=""
              className="object-cover w-full h-full"
            />
          </div>
          ...
          <div className=" bg-blue-100 rounded-xl md:w-90 md:h-72 overflow-hidden">
            <img
               src={posters.length > 0 ? posters[5]?.imageUrl : "https://firebasestorage.googleapis.com/v0/b/elite-mediator.appspot.com/o/1721057130775_landingPageImg3.avif?alt=media&token=e6b97baa-1d3b-4b6d-b961-d93f66388d25"}
              alt=""
              className="object-cover w-full h-full"
            />
          </div>
