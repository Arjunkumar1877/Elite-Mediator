      ...
      <div className={`transition-all duration-300 ${showNav ? "h-screen w-[250px] bg-sky-50" : "h-screen w-[60px] bg-sky-50"}`}>
        ...
        <div className="flex flex-col gap-10 items-center justify-center">
          ...
          <Link
            ...
            className={`relative flex gap-5 self-start px-5 hover:text-black cursor-pointer ${location.pathname === '/chat_list' ? 'text-black' : 'text-sky-500'} items-center text-xl`}
          >
