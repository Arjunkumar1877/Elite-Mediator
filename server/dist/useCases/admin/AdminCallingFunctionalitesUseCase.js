...
exports.AdminCallingFunctionalitesUseCase = void 0;
class AdminCallingFunctionalitesUseCase {
    constructor(iadminRepository) {
        this.iadminRepository = iadminRepository;
    }
    ;
    AdminStartCall(callData) {
    ...
    AdminDisconnectCall(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.iadminRepository.DisconnectAdminCallAndUpdateOnDb(id);
        });
    }
}
exports.AdminCallingFunctionalitesUseCase = AdminCallingFunctionalitesUseCase;
