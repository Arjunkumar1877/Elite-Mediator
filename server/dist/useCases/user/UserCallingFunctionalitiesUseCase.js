...
exports.UserCallingFunctionalitiesUseCase = void 0;
class UserCallingFunctionalitiesUseCase {
    constructor(iuserrepository) {
        this.iuserrepository = iuserrepository;
    }
    ;
    UserStartCall(callData) {
    ...
    UserDisconnectCall(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.iuserrepository.DisconnectUserCallAndUpdateOnDb(id);
        });
    }
}
exports.UserCallingFunctionalitiesUseCase = UserCallingFunctionalitiesUseCase;
